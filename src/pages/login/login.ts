    ...
    this.afAuth.auth.signInWithEmailAndPassword(this.form.controls['email'].value, this.form.controls['password'].value)
      ...
      .catch(() => {
        ...
        let alert = this.alertCtrl.create({
          title: 'Seems like we have a problem here',
          subTitle: 'We think your username or password might be wrong... Can you double check, please?',
          buttons: ['Sure!', 'I didn\'t want to Log In anyway...']
        });
        alert.present();
      });
  }
